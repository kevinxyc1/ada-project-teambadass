...
<button style="background-color: #003e1f; color: white; border: none; padding: 14px 20px; margin: 8px 0; cursor: pointer; width: 100%; border-radius: 25px;" onclick="swapImage()">Average revenue on/off</button>
...
<button style="background-color: #003e1f; color: white; border: none; padding: 14px 20px; margin: 8px 0; cursor: pointer; width: 100%; border-radius: 25px;" onclick="swapImage3('assets/img/flavour_plot2.png')">All connections</button>
<button style="background-color: #003e1f; color: white; border: none; padding: 14px 20px; margin: 8px 0; cursor: pointer; width: 100%; border-radius: 25px;" onclick="swapImage3('assets/img/non_community_edges.png')">Community connections</button>
<button style="background-color: #003e1f; color: white; border: none; padding: 14px 20px; margin: 8px 0; cursor: pointer; width: 100%; border-radius: 25px;" onclick="swapImage3('assets/img/community_graph.png')">Non-community connections</button>
